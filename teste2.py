...
def registrar_visitante():
    ...
    if nome and validar_cpf(cpf):
        ...
        send_notification('morador@gmail.com', 'Novo Visitante', f'O visitante {nome} foi registrado.')
...
def registrar_veiculo():
    ...
    if placa and modelo and cor:
        ...
        send_notification('morador@gmail.com', 'Novo Veículo', f'O veículo {placa} foi registrado.')
